...
public class FlushBlog1 {

	private WebDriver driver;

	private static String url = "http://blog.csdn.net/wanghantong";

	static Logger logger = Logger.getLogger(FlushBlog1.class);
	...
	public void testIndex() throws UnsupportedEncodingException, InterruptedException {
		...
		// first page is done
		WebElement papelist = driver.findElement(By.id("papelist"));
		papelist.findElement(By.tagName("a")).click();
